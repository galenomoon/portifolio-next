...
export default function SkillsAndExperience() {
  ...
  return (
    <section className='text-typography-white-100 py-20 bg-gradient-to-tr from-[#28272C] to-[#28272C] w-full min-h-screen max-h-fit relative items-center text-center justify-between  flex'>
      ...
      <article className='flex flex-col w-full h-full'>
        ...
        <section className='flex flex-col w-full h-full text-start text-lg px-28 gap-5 mb-20'>
          <p>
